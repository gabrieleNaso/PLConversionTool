...
- `datasets/corpus/`
  ...
  - `traduzione_awl/` (sorgenti AWL / note)
  - `traduzione_xml/` (XML di traduzione gia' fatti: riferimento per estrarre regole e fare regressione sul generatore)
- `examples/cases/`
  - `input/` (sorgenti AWL) + `expected/` (attesi) **versionati**
- `datasets/typicals/`
