...
class AwlIR:
    ...
    operand_categories: dict[str, str] = field(default_factory=dict)
    operand_notes: dict[str, str] = field(default_factory=dict)
    operand_control_settings: dict[str, dict[str, str]] = field(default_factory=dict)
