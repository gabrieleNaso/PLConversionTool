...
```bash
cd /home/administrator/PLConversionTool
docker compose -f compose.dev.yml exec tia-bridge ls -l /workspace/work/output/Graph_StressTest_Impianto_v3.xml
```
...
curl -X POST http://192.167.1.20:8010/api/jobs/import \
  ...
  -d '{
    "artifactPath": "work/output/Graph_StressTest_Impianto_v3.xml",
    "projectPath": "C:\\Users\\Admin\\Desktop\\prova_connessione_openness\\prova_connessione_openness.ap20",
    "targetPath": null,
    "targetName": null,
    "saveProject": true,
...
curl -X POST http://192.167.1.20:8010/api/jobs/import \
  -H 'Content-Type: application/json' \
  -d '{
    "artifactPath": "work/output/mia_cartella_xml",
    "projectPath": "C:\\Users\\Admin\\Desktop\\prova_connessione_openness\\prova_connessione_openness.ap20",
    "targetPath": "Program blocks/Group_1",
    "targetName": null,
    "saveProject": true,
...
curl -X POST http://192.167.1.20:8010/api/jobs/export \
  -H 'Content-Type: application/json' \
  -d '{
    "artifactPath": "work/output/remote_exports/Graph_StressTest_Impianto_v3.xml",
    "projectPath": "C:\\Users\\Admin\\Desktop\\prova_connessione_openness\\prova_connessione_openness.ap20",
    "targetPath": null,
    "targetName": "Graph_StressTest_Impianto_v3",
    "saveProject": false,
...
```bash
ls -l /home/administrator/PLConversionTool/work/output/remote_exports/Graph_StressTest_Impianto_v3.xml
```

### Export remoto di un gruppo intero verso Ubuntu

Esporta tutti i blocchi del gruppo `Group_1` nella directory Linux `work/output/remote_exports/Group_1`.

```bash
curl -X POST http://192.167.1.20:8010/api/jobs/export \
  -H 'Content-Type: application/json' \
  -d '{
    "artifactPath": "work/output/remote_exports/Group_1",
    "projectPath": "C:\\Users\\Admin\\Desktop\\prova_connessione_openness\\prova_connessione_openness.ap20",
    "targetPath": "Program blocks/Group_1",
    "targetName": null,
    "saveProject": false,
...
```bash
curl http://192.167.1.20:8010/api/jobs
ls -R /home/administrator/PLConversionTool/work/output/remote_exports/Group_1
```
...
curl -X POST http://192.167.1.20:8010/api/jobs/import \
  -H 'Content-Type: application/json' \
  -d '{
    "artifactPath": "work/output/generated/import-trial-linked/FB_Import_Trial_Linked_GRAPH_auto.xml",
    "projectPath": "C:\\Users\\Admin\\Desktop\\prova_connessione_openness\\prova_connessione_openness.ap20",
...
curl -X POST http://192.167.1.20:8010/api/jobs/import \
  -H 'Content-Type: application/json' \
  -d '{
    "artifactPath": "work/output/generated/complex-trial-fix",
    "projectPath": "C:\\Users\\Admin\\Desktop\\prova_connessione_openness\\prova_connessione_openness.ap20",
...
curl -X POST http://192.167.1.20:8010/api/jobs/compile \
  -H 'Content-Type: application/json' \
  -d '{
    "artifactPath": "work/output/generated/compile-request.json",
    "projectPath": "C:\\Users\\Admin\\Desktop\\prova_connessione_openness\\prova_connessione_openness.ap20",
    "targetPath": "Program blocks/generati da tool",
    "targetName": null,
    "saveProject": true,
...
curl -X POST http://192.167.1.20:8010/api/jobs/export \
  -H 'Content-Type: application/json' \
  -d '{
    "artifactPath": "work/output/remote_exports/Complex_Trial_Fix_GRAPH.xml",
    "projectPath": "C:\\Users\\Admin\\Desktop\\prova_connessione_openness\\prova_connessione_openness.ap20",
    "targetPath": "Program blocks/generati da tool/complex-trial-fix",
...
curl -X POST http://192.167.1.20:8010/api/jobs/export \
  -H 'Content-Type: application/json' \
  -d '{
    "artifactPath": "work/output/remote_exports/complex-trial-fix",
    "projectPath": "C:\\Users\\Admin\\Desktop\\prova_connessione_openness\\prova_connessione_openness.ap20",
    "targetPath": "Program blocks/generati da tool/complex-trial-fix",
    "targetName": null,
    "saveProject": false,
...
```bash
ls -l /home/administrator/PLConversionTool/work/output/remote_exports
find /home/administrator/PLConversionTool/work/output/remote_exports -maxdepth 3 -type f | sort
```
