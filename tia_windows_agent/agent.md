...
- un file XML presente in `work/output/` sulla VM Ubuntu viene caricato nella `TempDirectory` Windows;
...
- `/workspace/work/tmp`
- oppure path relative come `work/output/Type_28.xml` e `work/tmp/mia_cartella_xml`
...
Se il file XML e' sulla VM Ubuntu in `work/output/Type_28.xml`, puoi usare il bridge Linux cosi':

```bash
curl -X POST http://192.167.1.20:8010/api/jobs/import \
  -H 'Content-Type: application/json' \
  -d '{
    "artifactPath": "work/output/Type_28.xml",
    "projectPath": "C:\\Users\\Admin\\Desktop\\prova_connessione_openness\\prova_connessione_openness.ap20",
    "targetPath": null,
    "targetName": null,
    "saveProject": true,
...
- il modo piu' semplice e' usare `work/output/...` o `work/tmp/...` del repository;
