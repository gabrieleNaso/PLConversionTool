...
def get_runtime_paths() -> dict[str, str]:
    return {
        ...
        "output": os.getenv("TIA_OUTPUT_DIR", "/workspace/work/output").strip() or "/workspace/work/output",
        "tmp": os.getenv("TIA_TMP_DIR", "/workspace/work/tmp").strip() or "/workspace/work/tmp",
    }
